...
// iPhone/Safari bloquea el audio automático hasta que existe una interacción del usuario.
// Usamos el primer toque como gesto de activación y reproducimos la bienvenida una sola vez.
async function unlockAudio(){
  if(audioUnlocked || welcomePlayed) return true;
  audioUnlocked=true;
  welcomePlayed=true;
...
// El primer toque activa la voz. Se detiene la acción original para evitar dos audios a la vez.
function firstInteraction(e){
  if(audioUnlocked || welcomePlayed) return;
